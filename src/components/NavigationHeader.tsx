  ...
  return (
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <Link href="/snippets" className="flex items-center gap-3 group">
          ...
          <div className="hidden sm:block"> {/* Texto oculto em telas pequenas */}
    ...
    {isMenuOpen && (
      ...
      >
        ...
        <Link href="/snippets" className="block text-gray-300 hover:text-purple-400 transition-colors">
          Galeria de Códigos
        </Link>
        <Link href="/editor" className="block text-gray-300 hover:text-purple-400 transition-colors">
          Editor de Código
        </Link>
        <Link href="/pricing" className="block text-gray-300 hover:text-purple-400 transition-colors">
          Preço
        </Link>
      </motion.div>
    )}
